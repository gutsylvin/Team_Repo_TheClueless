 ...
 */
@Autonomous(name = "Beacon push test", group = "test")
public class BeaconPushOpMode extends LinearVisionOpMode {
    //region bloated shit
    enum BeaconTestType {
        VISIONPROCESSING,
        COLORSENSOR,
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            if (gamepad1.a) {
                type = BeaconTestType.VISIONPROCESSING;
            }
            if (gamepad1.b) {
                type = BeaconTestType.COLORSENSOR;
            }
            if (gamepad1.x) {
            ...
            switch (type) {
                case VISIONPROCESSING:
                    pushBasedOnState(getBeaconState());
                    break;
                case COLORSENSOR:
                    reviseColor();
                    break;
