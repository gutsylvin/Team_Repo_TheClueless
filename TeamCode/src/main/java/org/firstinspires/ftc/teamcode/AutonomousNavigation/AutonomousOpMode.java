...
public class AutonomousOpMode extends LinearOpMode {
    ...
    static final double TURN_SPEED = 0.10;     // Nominal half speed for better accuracy.
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.conveyorGate.setPosition(1);
        prepareShoot(true);
        Thread.sleep(2750);
        prepareShoot(false);
        gyroDrive(0.4, -1750, 0);
        gyroTurn(TURN_SPEED * 1.25, -90);
        gyroDrive(0.25, 2400, -90);
        gyroTurn(TURN_SPEED * 1.25, 0);
        gyroDrive(0.25, -50, 0);
        gyroDriveUntilLine(-0.08, 0.75);
        gyroDrive(0.25, 50, 0);
        gyroTurn(TURN_SPEED * 1.25, -90);
        gyroDrive(0.25, 400, -90);
        pushBeacon(0.25, -90);
        gyroTurn(TURN_SPEED * 1.25, 0);
        gyroDrive(0.25, -1500, 0);
        gyroDriveUntilLine(0.05, 0.75);
        gyroTurn(TURN_SPEED * 1.25, -90);
        gyroDrive(0.25, 1000, -90);
        pushBeacon(0.25, -90);
    ...
    void prepareShoot(boolean shooting) throws InterruptedException {
        ...
        robot.ballCollectionMotor.setPower(shooting ? -1 : 0);
    }
