 ...
 */
@TeleOp(name = "Calibrate Color Sensor", group = "util")
public class CalibrateColorSensor extends OpMode implements I2cPortReadyCallback {
    ...
    public synchronized void sendCommand(byte command) {
        ...
        try {
            ...
            controller.enableI2cWriteMode(port, I2cAddr.create8bit((int)COLOR_SENSOR_ADDR), 0x03, 1);
    ...
    public synchronized void portIsReady(int port) {
        ...
        switch (controller_mode) {
            ...
            case RESET:
                controller.enableI2cReadMode(port, I2cAddr.create8bit((int)COLOR_SENSOR_ADDR), 0x03, 6);
                controller.writeI2cCacheToController(port);
